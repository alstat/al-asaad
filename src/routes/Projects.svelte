				...
				<ul class="sci">
					<li style="--i:1">
						<div class="content-description">
							{#if project['label'] === 'Kitab.jl'}
								Julia package for Islamicate texts from
								<a href="https://kitab-project.org/">KiTaB</a>project<br />
							{:else}
								{project['desc']}<br />
							{/if}
						</div>
...
<style>
	...
	*::after {
	...
	.container .card .content .card-content h3 {
		font-weight: 500;
		font-size: inherit;
		text-align: center;
		margin: 20px 0 10px;
